...
public class ReealoServiceRest {
    ...
    @GET
    @Path("obtenerProductoE")
    @Produces(MediaType.APPLICATION_JSON)
    public Response obtenerProductoE() {
        try {
    ...
    @GET
    @Path(value = "obtenerProductoEjemplo")
    @Produces(value = MediaType.APPLICATION_JSON)
    public void obtenerProductoEjemplo(@Suspended final AsyncResponse asyncResponse) {
        executorService.submit(new Runnable() {
            public void run() {
                asyncResponse.resume(doObtenerProductoEjemplo());
            }
        });
    }

    private Response doObtenerProductoEjemplo() {
        try {
